# Obtained from: https://github.com/open-mmlab/mmsegmentation/tree/v1.1.1
# Modifications:
...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        if isinstance(loss_decode, dict):
            self.loss_decode = LOSSES.build(loss_decode)
        elif isinstance(loss_decode, (list, tuple)):
            self.loss_decode = nn.ModuleList()
            for loss in loss_decode:
                self.loss_decode.append(LOSSES.build(loss))
        else:
