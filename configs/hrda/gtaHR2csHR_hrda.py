...
train_dataloader = dict(
    dataset=dict(
        ...
        # image
        # target={'crop_pseudo_margins':[30, 240, 30, 30]} ##TODO: Fix error
        )
train_dataloader['dataset']['target'] = {'crop_pseudo_margins': [30, 240, 30, 30]}
...
runner_type='CustomRunner' ## Custom runner
